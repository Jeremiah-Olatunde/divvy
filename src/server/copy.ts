...
//         // if result (i.e. filter out) is true skip inserting line
//         if(result === true) return;

//         // if result (i.e. filter out) is false keep the original string
//         // if result is a string (i.e. map transform) that becomes the new string
